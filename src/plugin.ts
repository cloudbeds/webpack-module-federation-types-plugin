...
export class ModuleFederationTypesPlugin implements WebpackPluginInstance {
  ...
  apply(compiler: Compiler): void {
    ...
    // vacuously; the download-federated-types CLI is the path that fails loudly. Shared package
    // version mismatches are logged by downloadTypes and likewise only fail the CLI.
